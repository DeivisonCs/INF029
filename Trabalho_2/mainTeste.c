...
void testeInserirSemNada()
{
    ...
    printf("%d ", inserirNumeroEmEstrutura(2, 2) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d ", inserirNumeroEmEstrutura(-2, 2) == POSICAO_INVALIDA);
    printf("%d ", inserirNumeroEmEstrutura(0, 2) == POSICAO_INVALIDA);
...
void testeCriarEstrutura()
{
    ...
    printf("%d ", criarEstruturaAuxiliar(-2, 5) == POSICAO_INVALIDA);
    printf("%d ", criarEstruturaAuxiliar(0, 5) == POSICAO_INVALIDA);
    printf("%d ", criarEstruturaAuxiliar(11, 5) == POSICAO_INVALIDA);
    printf("%d ", criarEstruturaAuxiliar(2, -5) == TAMANHO_INVALIDO);
    printf("%d ", criarEstruturaAuxiliar(2, 0) == TAMANHO_INVALIDO);
    printf("%d ", criarEstruturaAuxiliar(2, 3) == SUCESSO);
...
void testeExcluir()
{
    ...
    printf("%d ", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO);
    printf("%d ", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO);
    printf("%d ", excluirNumeroDoFinaldaEstrutura(0) == POSICAO_INVALIDA);
    printf("%d ", excluirNumeroDoFinaldaEstrutura(1) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d ", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO);
...
void testeExcluirNumeroEspecifico()
{
    ...
    printf("%d ", criarEstruturaAuxiliar(9, 3) == SUCESSO);
    printf("%d ", inserirNumeroEmEstrutura(9, 7) == SUCESSO);
    printf("%d ", inserirNumeroEmEstrutura(9, 4) == SUCESSO);
    printf("%d ", excluirNumeroEspecificoDeEstrutura(9, 12) == NUMERO_INEXISTENTE);
    printf("%d ", excluirNumeroEspecificoDeEstrutura(9, 7) == SUCESSO);
    printf("%d ", excluirNumeroEspecificoDeEstrutura(9, 4) == SUCESSO);
...
void testeListar()
{
    ...
    printf("%d ", inserirNumeroEmEstrutura(2, 7) == SUCESSO);
    printf("%d\n", inserirNumeroEmEstrutura(2, -9) == SUCESSO);

    int vet[2];

    printf("%d ", getDadosEstruturaAuxiliar(1, vet) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d ", getDadosEstruturaAuxiliar(11, vet) == POSICAO_INVALIDA);
    printf("%d\n", getDadosEstruturaAuxiliar(2, vet) == SUCESSO);

    printf("%d ", vet[0] == 7);
    printf("%d\n", vet[1] == -9);

    printf("%d ", getDadosOrdenadosEstruturaAuxiliar(1, vet) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d ", getDadosOrdenadosEstruturaAuxiliar(11, vet) == POSICAO_INVALIDA);
...
void testeRetornarTodosNumeros()
{
    ...
    printf("%d ", inserirNumeroEmEstrutura(2, 3) == SUCESSO);
    printf("%d ", inserirNumeroEmEstrutura(2, 8) == SUCESSO);
...
*/
    ...
    printf("%d ", inserirNumeroEmEstrutura(5, 1) == SUCESSO);
    printf("%d ", inserirNumeroEmEstrutura(5, 34) == SUCESSO);
    printf("%d ", inserirNumeroEmEstrutura(5, 12) == SUCESSO);
    printf("%d ", inserirNumeroEmEstrutura(5, 6) == SUCESSO);
    printf("%d ", inserirNumeroEmEstrutura(5, 27) == SUCESSO);
